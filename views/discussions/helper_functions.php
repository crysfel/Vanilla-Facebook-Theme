...
<li class="<?php echo $CssClass; ?>">
   ...
   ?>
   <div class="ItemContent Discussion clearfix">
	  <?php
		if($Discussion->FirstPhoto != '') {
			...
			echo Img("themes/tweetmylove/design/images/unknow-user-female.jpg",array("class"=>"unknow-user"));
		}
	   ?>
      ...
      <p><?php echo substr(strip_tags($Discussion->Body),0,140); ?> <?php echo Anchor("more...", '/discussion/'.$Discussion->DiscussionID.'/'.Gdn_Format::Url($Discussion->Name).($Discussion->CountCommentWatch > 0 && C('Vanilla.Comments.AutoOffset') ? '/#Item_'.$Discussion->CountCommentWatch : '')); ?></p>
